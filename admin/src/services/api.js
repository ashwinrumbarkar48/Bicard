...
export const API_URL = import.meta.env.VITE_API_URL || 'https://bicard-1.onrender.com/api';
export const ASSET_URL = import.meta.env.VITE_ASSET_URL || 'https://bicard-1.onrender.com';
